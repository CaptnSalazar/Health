...
public abstract class AbstractStepDetectorService extends IntentService implements SensorEventListener, SharedPreferences.OnSharedPreferenceChangeListener {
     ...
     */
    public static final String BROADCAST_ACTION_STEPS_DETECTED = "com.example.kiit.health.STEPS_DETECTED";
    /**
     * Extra key for new steps which were added since last broadcast.
     */
    public static final String EXTENDED_DATA_NEW_STEPS = "com.example.kiit.health.NEW_STEPS";
    /**
     * Extra key for total step count since service start
     */
    public static final String EXTENDED_DATA_TOTAL_STEPS = "com.example.kiit.health.TOTAL_STEPS";
    /**
